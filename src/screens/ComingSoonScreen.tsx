  ...
  return (
    ...
    >
      <div className='w-full relative text-base-100 min-h-screen flex flex-col items-center justify-center gap-5'>
        <div className='head'>
          <h2 className='font-["montserrat"] font-black text-[36px] md:text-6xl lg:text-8xl after:bg-base-100 after:content-[""] after:w-24 text-base-100 after:h-1 after:block after:mx-auto after:mt-5'>
            COMING SOON !!
          </h2>
          <aside className='font-["Roboto_slab"] font-bold mt-1 md:mt-8 text-lg md:text-2xl'>
        ...
        <div className='my-5 md:my-10 flex items-center justify-evenly flex-wrap'>
          <div className='counter w-[140px] sm:w-[160px] m-3 pt-1.5 px-2.5 pb-5 flex items-center flex-col bg-accent'>
            <span className='counter-days font-["montserrat"] text-7xl font-black'>
              00
            </span>
            <span className='label-text'>Days</span>
          </div>
          <div className='counter w-[140px] sm:w-[160px] m-3 pt-1.5 px-2.5 pb-5 flex items-center flex-col bg-accent'>
            <span className='counter-hours font-["montserrat"] text-7xl font-black'>
              00
            </span>
            <span className='label-text'>Hours</span>
          </div>
          <div className='counter w-[140px] sm:w-[160px] m-3 pt-1.5 px-2.5 pb-5 flex items-center flex-col bg-accent'>
            <span className='counter-minutes font-["montserrat"] text-7xl font-black'>
              00
            </span>
            <span className='label-text'>Minutes</span>
          </div>
          <div className='counter w-[140px] sm:w-[160px] m-3 pt-1.5 px-2.5 pb-5 flex items-center flex-col bg-accent'>
            <span className='counter-seconds font-["montserrat"] text-7xl font-black'>
              00
            </span>
